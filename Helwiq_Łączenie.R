...
png(filename = paste0("./Wyniki/Wzorzec_vs_Biomasa/", regexy, ".png"),
...
points(Biomasa,y, col=ifelse(x==0, "white", "green"),cex= 2)
points(Patenty,y, col=ifelse(x==0, "white", "red"),cex= 2)
  ...
  text(Biomasa[2:29],y[2:29], labels=Państwa_Biomasa, cex= 0.7,  pos=3, col = "green")
  text(Patenty[2:29],y[2:29], labels=Państwa_Patenty, cex= 0.7,  pos=3, col = "red")
